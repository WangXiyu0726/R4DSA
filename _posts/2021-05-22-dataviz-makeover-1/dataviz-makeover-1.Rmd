...
![Figure 1](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture1.jpg)
...
![Figure 2](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture2.jpg)
...
![Figure 3](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture3.jpg)  
Remove the redundant rows and columns. Rename table and headers.  
![Figure 4](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture4.jpg)  
Change the data type of the trade volume into number.  
![Figure 5](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture5.jpg)  
...
![Figure 6](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture6.jpg)  
Click view data in Tableau and export two tables of **Import** and **Export**.  
![Figure 7](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture7.jpg)  
...
![Figure 8](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture8.jpg)  
Add **Category**, **YEAR(Date)**, **MONTH(Date)** to the Column tab and **SUM(Trade Volume)** to the Rows tab.  
![Figure 9](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture9.jpg)  
Add **Category**, **YEAR(Date)**, **MONTH(Date)**, **Country/Region** to Filter and show them in the right panel.  
![Figure 10](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture10.jpg)  
Add **Category** to the Colour option to differentiate the performance of the Export Volume and Import Volume.  
![Figure 11](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture11.jpg)  
Add another copy of **SUM(Trade Volume)** and change it to dual axis.  
![Figure 12](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture12.jpg)  
Right click on the right Y-axis, select Synchronize Axis and deselect Show Header.  
![Figure 13](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture13.jpg)  
Change panel from Automatic to Circle and choose an appropriate size for the mark.  
![Figure 14](C:/Users/adminq/Desktop/Visual Analysis/DataViz Makeover/DataViz Makeover1/img/Picture14.jpg)  
